...
import 'package:flutter_app_reclame_ja/screens/signup_screen.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Center(
          ...
          children: [
            openDialogButton("Sign In", onSignInSuccess, SignInScreen()),
            openDialogButton(
                "Sign Up", () => {print("sign up success")}, SignUpScreen())
          ],
        )));
  }
}
